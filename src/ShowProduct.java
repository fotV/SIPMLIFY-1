...
public class ShowBuyerSeller {
	...
	public ShowBuyerSeller(User user){
		if (user instanceof OrderManager) {
			OrderManager byr = (OrderManager) user;
		...
		labelName = new JLabel(cl.getFirstName());
		labelName.setBounds(613, 70, 150, 32);
		labelName.setFont(new Font("HelveticaNeue", Font.PLAIN,24));
		frame.getContentPane().add(labelName);
		
		
		labelLastName = new JLabel(cl.getSurName());
		...
		labelPhoneNumber = new JLabel(cl.getPhonenumber()+"hello");
